...
// WebColor implementation using generic Ember Object

var WebColor = Ember.Object.extend({
    // Rainbow ROYGBIV
    rainbow: ['red', 'orange', 'yellow', 'green', 'blue', 'indigo', 'violet'],
  
    // Official Named Colors (grouped alphabetically)
    namedColors: [
  ...
  allcolors: function(){
    ...
    this.get('rainbow').forEach(function(item) {
      collection.push(item);  
    });

    this.get('namedColors').forEach(function(item) {
      collection.push(item);  
    });

    this.get('grayScale').forEach(function(item) {
      collection.push(item);  
    });

    this.get('webSafe').forEach(function(item) {
      collection.push(item);  
    });

    return collection;
  }.property('rainbow', 'namedColors', 'grayScale', 'webSafe')
